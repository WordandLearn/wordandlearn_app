...
String lessonCompletedUrl(int lessonId) =>
    "$lessonTopicsUrl/$lessonId/complete/";
...
const String compositionUrl = "$writingUrl/composition";
...
const String userSubscriptionUrl = "$paymentUrl/subscription/?service=W";
